    ...
    <div class="container">
        <div class="row" style="padding:40px 0 0 0;">
            <div class="col-md-4 col-sm-6 col-12">
                ...
                <div><a href="{{ route('articles', app()->getLocale()) }}" class="a-green-xl">{{ trans('site.Articles') }}</a></div>
            ...
            <div class="col-md-4">
                ...
                <div><a href="{{ route('cat-o-dog', app()->getLocale()) }}" class="a-green-xl">{{ trans('site.Cat-o-dog') }}</a></div>
                ...
                <div><a href="<?=config('app.url')?>/sitemap.xml" class="a-green-xl">Sitemap</a></div>
                <br/>
            </div>
            <div class="col-md-12">
