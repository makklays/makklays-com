...
<div class="row" style="margin-left: 0; margin-right:0;">
    <div class="col-md-12">
        ...
        <div class="text-center" style="margin: 40px 0 0 0;">
            ...
            <div>
                <img src="/img/test-php-question-3.svg" style="width:300px;" title="Quiz PHP" alt="Quiz PHP" />
            </div>
            ...
            <div style="margin: 20px 0;">
                <form action="{{ route('test_php_a3', app()->getLocale()) }}" method="post">
                    {{ csrf_field() }}
...
<div style="text-align:center; width:322px; margin-top:40px; margin-left:auto; margin-right:auto; ">
    <div style="margin: 40px 0 10px 0;">
        ...
        <a class="green" href="{{ route('test_php_q3', 'es') }}">ES</a> |
        <a class="green" href="{{ route('test_php_q3', 'en') }}">EN</a> |
        <a class="green" href="{{ route('test_php_q3', 'ru') }}">RU</a> |
        <a class="green" href="{{ route('test_php_q3', 'ch') }}">CH</a>
    </div>
