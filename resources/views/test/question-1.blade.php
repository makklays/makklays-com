...
<head>
    ...
    <meta property="og:url" content="{{ config('app.url', 'http://makklays.com') }}" />
    <meta property="og:image" content="{{ config('app.url', 'http://makklays.com') }}/img/PHP-logo.png" />
...
<div style="text-align:center; width:322px; margin-top:40px; margin-left:auto; margin-right:auto; ">
    <div style="margin: 40px 0 10px 0;">
        <a class="green" href="{{ route('test_php_q1', 'ua') }}">UA</a> |
